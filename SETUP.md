...
## 2. Put the app online (2 min, free, no account needed)

1. Go to **app.netlify.com/drop** in a browser.
2. Drag the whole unzipped `holiday-app` folder onto the page.
3. It gives you a public `https://something.netlify.app` URL immediately —
   that's your app's address. (You can rename/claim it later by creating a
   free Netlify account if you want, but you don't have to.)
...
After editing, just re-drag the folder onto Netlify Drop again (or connect
it to a GitHub repo for auto-deploys, if you want to go further).
